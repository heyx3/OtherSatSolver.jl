...
"The complex solver uses `Float64`, then translates back to `Rational` within this margin of error."
const FLOAT_PRECISION = Ref(0.00001)

"
Solves a factory that includes multiple recipes and waste products/feedback loops.
"
function solve_complex(floor::FactoryFloor, log_io::IO = devnull)::Optional{FactoryOverview}
    #=
    ...
    for item in all_items
        func_expr = 0 # To start, there is nothing changing the amount of item produced
